...
use PlugHacker\PlugCore\Recurrence\Interfaces\SubProductEntityInterface;
...
class SubProduct extends AbstractEntity implements SubProductEntityInterface
{
    ...
    /** @var \PlugHacker\PlugCore\Recurrence\Aggregates\Repetition */
    ...
    public function jsonSerialize(): mixed
    {
        return [
            ...
            "plugId" => $this->getPlugIdValue(),
        ];
    }

    /**
     * @return \PlugHacker\PlugCore\Recurrence\ValueObjects\PricingSchemeValueObject
     */
     ...
     * @return string|null
     */
    public function getPlugIdValue()
    {
        if (empty($this->getPlugId())) {
            return null;
        }
        return $this->getPlugId()->getValue();
    }
}
